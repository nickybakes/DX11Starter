...
void Game::CreateGeometry()
{
	...
	XMFLOAT4 scarlet = XMFLOAT4(1.0f, 0.0f, 0.36f, 1.0f);

	XMFLOAT4 darkGreen = XMFLOAT4(0.0f, 0.5f, 0.0f, 1.0f);
	...
	Vertex mesh1Vertices[] =
	{
		...
		{ XMFLOAT3(+0.3f, -0.5f, +0.0f), scarlet },
		{ XMFLOAT3(-0.5f, -0.5f, +0.0f), scarlet },
	};
	unsigned int mesh1Indices[] = { 0, 1, 2, 0, 2, 3 };
	...
	//mesh 2 is a tri force
	Vertex mesh2Vertices[] =
	{
		{ XMFLOAT3(-0.7f, +0.7f, +0.0f), yellow },
		{ XMFLOAT3(-0.65f, +0.6f, +0.0f), red },
		{ XMFLOAT3(-0.75f, +0.6f, +0.0f), red },
		{ XMFLOAT3(-0.65f, +0.6f, +0.0f), yellow },
		{ XMFLOAT3(-0.6f, +0.5f, +0.0f), blue },
		{ XMFLOAT3(-0.7f, +0.5f, +0.0f), blue },
		{ XMFLOAT3(-0.75f, +0.6f, +0.0f), yellow },
		{ XMFLOAT3(-0.7f, +0.5f, +0.0f), darkGreen },
		{ XMFLOAT3(-0.8f, +0.5f, +0.0f), darkGreen },
	};
	unsigned int mesh2Indices[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
	...
	//mesh 2 is an X of tris
	Vertex mesh3Vertices[] =
	{
		{ XMFLOAT3(+.6f, -0.5f, +0.0f), black },
		{ XMFLOAT3(+.7f, -0.6f, +0.0f), black },
		{ XMFLOAT3(+.6f, -0.7f, +0.0f), black },
		{ XMFLOAT3(+.5f, -0.6f, +0.0f), black },
		{ XMFLOAT3(+.6f, -0.6f, +0.0f), white },

		{ XMFLOAT3(+.4f, -0.4f, +0.0f), red },
		{ XMFLOAT3(+.8f, -0.4f, +0.0f), blue },
		{ XMFLOAT3(+.8f, -0.8f, +0.0f), yellow },
		{ XMFLOAT3(+.4f, -0.8f, +0.0f), darkGreen },
